...
HD_PWD='/home/jodalyst/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flasher.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flasher.tcl -notrace
