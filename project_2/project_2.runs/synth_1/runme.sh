...
HD_PWD='/home/jodalyst/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flasher.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flasher.tcl
