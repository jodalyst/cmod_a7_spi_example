...
HD_PWD='/home/jodalyst/vivado/spi_tester_b/spi_tester_b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_system.tcl -notrace
