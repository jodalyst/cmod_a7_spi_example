...
HD_PWD='/home/jodalyst/vivado/spi_tester_b/spi_tester_b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_system.tcl
